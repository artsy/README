...
description: A list of things to complete when you start
---
...
- [ ] Run the script in https://github.com/artsy/potential/blob/master/scripts/setup for initial setup.
...
- [ ] Scan our list of preferred technologies. Dig in where necessary.
  - [ ] Javascriptures
  - [ ] Rails tutorial
  - [ ] iOS?/React Native (blog post)
- [ ] Join the #incidents slack channel and scan through some recent threads
      Read the [support doc](https://github.com/artsy/potential/blob/master/Support.md)
- [ ] On-call onboarding (watch that video, etc.)
