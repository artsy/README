...
- Provide a safe space for sounding other questions and concerns (though _not_ as a replacement for People Ops or the mentee's manager)
...
Meeting 1:1 is one way to support them, but the overall goal is to _help them feel comfortable and productive on the team_. Keeping in mind that every new engineer brings their own package of skills and past experiences, here is one sample itinerary:
...
- [🔒 Artsy's Mentorship Program](https://www.notion.so/artsy/Mentorship-Program-014ba1ab5a0044d6ac0de0242c7779a4) as part of the Inclusion Working Group
