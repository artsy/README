...
The `isVisible` prop is passed to all top-level components (ie: components backed by a component view controller). This
...
When ran in development mode, Emission sends the full GraphQL query and variables to Metaphysics. However,
