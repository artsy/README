To modify Artsy's [draft] technology radar, edit the
...
Move an entry to `artsy-tech-radar-archive.csv` if the technology is no longer part of artsy's tech stack or we
